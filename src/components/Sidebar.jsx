...
const Sidebar = () => {
  ...
  return (
    <aside className="flex h-screen w-72 shrink-0 flex-col border-r border-zinc-800/80 bg-zinc-950">
      ...
      <div className="border-t border-zinc-800/80 px-4 py-4">
        <div className="flex items-center gap-3 rounded-xl border border-zinc-800/80 bg-zinc-900/70 p-3">
